      ...
      >
        ...
        <List>
          <ListItem
            button
            key={"Home"}
            onClick={() => (window.location = "/recipes")}
          >
            <ListItemIcon>
              <HomeIcon />
            </ListItemIcon>
          ...
          <ListItem
            button
            key={"AddRecipe"}
            onClick={() => (window.location = "/addrecipe")}
          >
            <ListItemIcon>
              <AddIcon />
            </ListItemIcon>
          ...
          <>
            <List>
              <ListItem
                button
                key={"Favorite"}
                onClick={() => (window.location = "/favorites")}
              >
                <ListItemIcon>
                  <FavoriteIcon />
                </ListItemIcon>
              ...
              <ListItem
                button
                key={"CreateMenu"}
                onClick={() => (window.location = "/createmenu")}
              >
                <ListItemIcon>
                  <CreateIcon />
                </ListItemIcon>
